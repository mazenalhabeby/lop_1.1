...
const JobAplication = () => {
  return (
    <div className="flex flex-col space-y-11 bg-gradient-to-r from-slate-800 to-yellow-900 py-10 text-center text-white">
      <div className=" flex flex-col gap-y-2">
        <h2 className=" font-aclonica text-xl uppercase tracking-wider">
