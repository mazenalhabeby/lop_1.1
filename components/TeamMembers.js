      ...
      Links: [
        {
          id: 1,
          socialMedia: 'Twitter',
          link: 'https://twitter.com/AsadzeeshanAZ',
          socialIcon: FaTwitter,
        },
        {
          id: 2,
                      ...
                      {obj.Links.map((link) => {
                        return (
                          <Link href={link.link} key={link.id}>
                            <a
                              className="mt-3 flex h-14 w-14 flex-row items-center justify-center rounded-xl nm-inset-slate-100-lg dark:nm-inset-slate-700-xl"
                              target={'_blank'}>
                              <link.socialIcon className="align-middle text-3xl text-yellow-600 dark:text-yellow-500" />
                            </a>
                          </Link>
                        )
                      })}
