...
export const contractLinkAddress = '0x0FA8781a83E46826621b3BC094Ea2A0212e71B23'

export const getUsdcContract = (library, account) => {
  const signer = library?.getSigner(account).connectUnchecked()
  var contract = new Contract(contractLinkAddress, USDC_ABI, signer)
  return contract
}
